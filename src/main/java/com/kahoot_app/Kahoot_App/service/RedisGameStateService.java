...
@Service
public class RedisGameStateService implements GameStatusStore, ScoreStore, AnswerStore, QuestionTimerStore {
    ...
    public long getTimerTTL(String roomCode) {
        String key = "room:" + roomCode + ":timer";
